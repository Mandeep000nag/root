#bin/bash
#agar kisi madarchod ne script ke saath ched shaad ke to ma chod du ga
#script By Mandeep000NAG
...
\e[0m'
printf "\n"
printf "                \e[101m\e[1;77m  >>  Script By Mandeep << \e[0m\n"
printf "\n"
printf "       \e[100m\e[1;77m >>  https://www.github.com/ : \e[1;96m mandeep000nag \e[100m\e[1;77m << \e[0m\n"
printf "\n"
}
baner1(){
clear
...
printf "                \e[101m\e[1;77m  >>  Script By Mandeep << \e[0m\n"
printf "\n"
printf "       \e[100m\e[1;77m >>  Github : \e[1;96m Mandeep000nag \e[100m\e[1;77m << \e[0m\n"
printf "\n"
}
echo 
menu1(){
...
am start -a android.intent.action.VIEW -d http://www.github.com/mandeep000nag > /dev/null 2>&1
banner
menu1
elif [[ $option == 6 || $option == 06 ]]; then
am start -a android.intent.action.VIEW -d https://wa.me/7710282339 > /dev/null 2>&1
banner
menu1
...
echo -e "                                                                                                  
      ...
      ┃ MANDEEP000NAG┃| $grn$cod HARDWARE=$o" $hardw"$grn
      ┃━━━━━ ○ ━━━━━┃| $grn$cod MODEL=$o" $modl"$grn
      ╰━━━━━━━━━━━━━╯
"
center "^CHECKING DONE^"
echo -e "\e[93m                     Follow on github\e[92m"
center "<Mandeep000nag>"
sleep 20.0
more
}
vid(){
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d http://github.com/mandeep000nag 2>/dev/null
clear
baner1
menu1
elif [ "$p" = "t" ];
...
if [ "$opts" = "1" ];
then
am start -a android.intent.action.VIEW -d http://www.github.com/mandeep000nag 2>/dev/null
help
elif [ "$opts" = "2" ];                             
then
am start -a android.intent.action.VIEW -d http://www.github.com/mandeep000nag 2>/dev/null
